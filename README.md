...
| 방법론 | 
1. openposenet 신경망을 이용한 input의 body pose를 측정 
2. body pose에 shape을 넣어 skeleton을 픽토그램화 
3. 이진영상 필터링으로 픽토그램만 남기고 흰 배경 처리 
4. googlenet 신경망을 통해 사진의 스포츠 종목을 판단, 픽토그램 공 위치 결정|
